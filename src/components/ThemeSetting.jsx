...
const ThemeSetting = () => {
  ...
  return (
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen dark:text-green-200 bg-white dark:bg-main-dark-bg w-400'>
        ...
        <p className='font-semibold text-lg text-gray-500'>Theme Options</p>
        <div className='mt-4'>
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'> 
        <p className='font-semibold text-lg text-gray-500'>Theme Colors</p>
