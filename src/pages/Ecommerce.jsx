...
import {SparkLine,Pie,Button, StackedChart} from   "../components";
        ...
        className='bg-white   dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$45,875.87</p>
            </div>
          </div>
          <div className='mt-6'>
                ...
                <div className='bg-white dark:text-green-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
                  <div className='flex justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <p className='flex items-center gap-2 text-green-600 hover:drop-shadow-xl'><span><GoDotFill /></span>
                      <span>Budgets</span>
                      </p>
                    </div>
                  ...
                  <div className='mt-10 flex gap-10 justify-center flex-wrap'>
                    <div className='border-r-1 border-color m-4 pr-10'>
                      <div>
                      <p>
                        <span className='text-3xl font-semibold'>$45,875.87</span>
                      ...
                      <div className='mt-8'>
                      <p>
                        <span className='text-3xl font-semibold'>$20,875.87</span>
